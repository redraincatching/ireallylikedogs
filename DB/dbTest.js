...
async function test(){
    ...
    // const id2 = await db.getID("definitely_not_liam");
    // db.updateProfile(id2, "name", "Liam");
    // console.log(await db.getProfileInfo(await db.getID("definitely_not_liam")));
    db.getArtistIDs("Liam");
}
